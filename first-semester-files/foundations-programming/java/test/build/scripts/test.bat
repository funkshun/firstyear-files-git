...
set CLASSPATH=%APP_HOME%\lib\test.jar;%APP_HOME%\lib\joda-time-2.2.jar

@rem Execute test
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %TEST_OPTS%  -classpath "%CLASSPATH%" hello.Hello %CMD_LINE_ARGS%
